<?php 
$user = $conn->query("SELECT * FROM donor where id ='".$_settings->userdata('id')."'");
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
                        ...
                        <!--<div class="form-group col-md-4">
                            ...
                            <input type="text" id="middlename" name="middlename" class="form-control form-control-sm form-control-border" value="<?//= isset($middlename) ? $middlename : "" ?>
                    ...
                    <div class="row">
						...
						<small class="text-muted"><i>Leave the New Password field blank if you do not want to update it.</i></small>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
...
<script>
	...
	$(function(){
		...
		$('#manage-user').submit(function(e){
			...
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Users.php?f=save_donor",
